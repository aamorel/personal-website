...
export const buttonAnim: Variants = {
  init: {
    ...
    background:
      "radial-gradient(70% 90% at 50% 100%, rgb(100, 100, 100) 0%, rgb(100, 100, 100) 100%)",
    transition: {
      ease: [0.33, 1, 0.68, 1],
      duration: 0.3,
    },
  ...
  anim: {
    scale: 1.1,
    boxShadow:
      "0 0 0.5rem 0.5rem rgba(65, 18, 161, 1), 0 2px 0 0 rgb(120, 54, 250) inset, 0 -2px 0 0 rgb(86, 4, 250) inset",
